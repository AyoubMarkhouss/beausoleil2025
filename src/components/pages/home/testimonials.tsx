...
const Testimonials = () => {
  ...
  return (
    <div className="bg-textblue py-10 md:py-20 ">
      <div className="mx-7 lg:mx-20">
        <div className="mb-10 flex flex-col gap-3 md:mb-12">
          ...
          <p className="max-w-2xl text-base text-gray-400 md:text-xl">
            Découvrez ce que nos voyageurs ont à dire sur leurs expériences.
            Leurs retours nous incitent à continuer d&apos;offrir un excellent
            service.
          </p>
        </div>
        <Slider {...settings}>
            ...
            <div className="flex max-w-sm flex-col rounded-2xl shadow-lg shadow-slate-700">
              ...
              <div className="flex flex-col items-center justify-center rounded-b-xl bg-orangeboom p-8">
                <Image
                  ...
                  alt=""
                  className="-mt-16 object-cover mb-2 h-16 w-16 rounded-full bg-gray-500 bg-cover bg-center"
                />
